...
pdata: 0.01, ptest: 0.01
datatrain: 64743 x 6223
pdata: 0.05, ptest: 0.01
traindata2:
pdata: 0.005, ptest: 0.01
traindata0:
...
Fit - 3 data points: traindata0, traindata, traindata2
  1 graph: time, no error bars
Predict - 5*3 data points: smalltest, small500, small1000
